...
var firebaseConfig = {
  apiKey: "AIzaSyBaEWoWUZS7x855dnrc57B9GSvLTHZYhvU",
  authDomain: "talkie-2e1a8.firebaseapp.com",
  databaseURL: "https://talkie-2e1a8.firebaseio.com",
  projectId: "talkie-2e1a8",
  storageBucket: "talkie-2e1a8.appspot.com",
  messagingSenderId: "937385721452",
  appId: "1:937385721452:web:8fab10181ecee80394a249",
  measurementId: "G-T488L9LBLT"
};
// Initialize Firebase
...
export default {
  data() {
    return {
      ...
      f7params: {
        id: "io.framework7.talkie", // App bundle ID
        name: "Talkie", // App name
